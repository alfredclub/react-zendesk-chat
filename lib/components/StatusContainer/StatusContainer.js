...
var StatusContainer = function (_Component) {
  ...
  _createClass(StatusContainer, [{
    ...
    key: 'isDisplayingChatContent',
    value: function isDisplayingChatContent() {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        this.isDisplayingChatContent() && _react2.default.createElement(
          'div',
          { className: 'back-arrow-container', onClick: this.props.onBackClick },
          _react2.default.createElement('div', { className: 'back-arrow' })
        ),
