...
var _SystemMessage = require('components/SystemMessage');
...
var _OfflineForm = require('components/OfflineForm');

var _OfflineForm2 = _interopRequireDefault(_OfflineForm);

var _PrechatForm = require('components/PrechatForm');

var _PrechatForm2 = _interopRequireDefault(_PrechatForm);

var _ChatRating = require('components/ChatRating');
  ...
  _createClass(MessageList, [{
    ...
    value: function renderByType(msg, addClass) {
      switch (msg.type) {
        ...
        case 'typing':
          return _react2.default.createElement(_SystemMessage2.default, {
            key: msg.type + msg.timestamp,
            message: msg
          });
        case 'chat.rating':
...
MessageList.propTypes = {
  ...
  agents: _react2.default.PropTypes.object,
  isOffline: _react2.default.PropTypes.bool,
  isChatting: _react2.default.PropTypes.bool
};
