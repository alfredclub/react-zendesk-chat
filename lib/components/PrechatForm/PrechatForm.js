...
var _CardContainer = require('components/CardContainer');

var _CardContainer2 = _interopRequireDefault(_CardContainer);

var _MessageSvg = require('components/MessageSvg');
  ...
  _createClass(PrechatForm, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        { title: 'Introduce yourself!', addClass: 'offline-card', contentAddClass: this.state.sent ? 'sent' : '', icon: _react2.default.createElement(_MessageSvg2.default, null) },
        this.renderChild()
      );
    }
  }]);
