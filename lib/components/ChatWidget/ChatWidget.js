...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      _eventsSystem.EventsSystem.subscribe('display', this.setVisible.bind(this, true)).subscribe('displayNewMessage', this.displayMessage);
    }
  }, {
    ...
    value: function componentWillUnmount() {
      ...
      _eventsSystem.EventsSystem.unsubscribe('display', this.setVisible.bind(this, true)).unsubscribe('displayNewMessage', this.displayMessage);
    }
  }, {
    key: 'setVisitorInfo',
    ...
    value: function chatButtonOnClick() {
      this.setVisible(true);
      _eventsSystem.EventsSystem.emit('onShow');
    }
  }, {
    key: 'setVisible',
